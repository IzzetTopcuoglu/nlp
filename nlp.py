...
df = pd.read_csv("C:/Users/izzet/PycharmProjects/DSMLBC9/nlp/datasets/amazon_reviews.csv", sep=",")
df.head()
...
tr_mask = np.array(Image.open("C:/Users/izzet/PycharmProjects/DSMLBC9/nlp/tr.png"))
